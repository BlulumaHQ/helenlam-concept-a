    ...
    <section id="services" className="py-24 bg-background">
      <div className="container-luxury">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="text-gold uppercase tracking-[0.3em] text-xs">Services</span>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-card p-10 rounded-lg shadow-card border border-border hover:shadow-luxury transition-smooth">
            <div className="w-14 h-14 rounded-md gradient-gold flex items-center justify-center mb-6">
            ...
            <ul className="space-y-3 mb-8">
              {[{i:Search,t:"Personalized home search"},{i:BarChart3,t:"Market insights & pricing data"},{i:Handshake,t:"Negotiation support that protects you"}].map(({i:Icon,t})=>(
                <li key={t} className="flex items-center gap-3 text-foreground">
                  <Icon className="h-5 w-5 text-gold" />{t}
                </li>
              ))}
            </ul>
          ...
          <div className="bg-card p-10 rounded-lg shadow-card border border-border hover:shadow-luxury transition-smooth">
            ...
            <a href="#evaluation" className="inline-flex items-center justify-center w-full gradient-gold text-ink font-semibold py-3 rounded-md hover:opacity-90 transition-smooth">
              Get My Home Value →
            </a>
          </div>
        </div>
