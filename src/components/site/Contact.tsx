  ...
  return (
    <section id="contact" className="section-pad bg-background">
      <div className="container-luxury grid lg:grid-cols-2 gap-16">
        <div>
          <span className="text-brand uppercase tracking-eyebrow text-xs">Get In Touch</span>
          <h2 className="font-serif text-4xl md:text-5xl mt-4 mb-6 leading-[1.1]">Let's Start the Conversation</h2>
          ...
          <div className="space-y-6">
            <a href="tel:778-889-6084" className="flex items-center gap-5 group">
              ...
              <div>
                <p className="text-xs text-muted-foreground uppercase tracking-eyebrow">Cell</p>
            ...
            <a href="mailto:sold@helenlam.ca" className="flex items-center gap-5 group">
              ...
              <div>
                <p className="text-xs text-muted-foreground uppercase tracking-eyebrow">Email</p>
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                <p className="text-xs text-muted-foreground uppercase tracking-eyebrow">Office</p>
